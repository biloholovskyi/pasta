...
function menu() {
  ...
  add_theme_support( 'post-thumbnails', array('post', 'product', 'recipes', 'contact', 'city') );
...
function register_post_types(){
  ...
  register_post_type('city', array(
    ...
    'labels' => array(
      ...
      'new_item'           => 'Новий Город', // текст новой записи
      'view_item'          => 'Смотреть Город', // для просмотра записи этого типа.
      'search_items'       => 'Искать Город', // для поиска по этим типам записи
      'not_found'          => 'Не найден Город', // если в результате поиска ничего не было найдено
      'not_found_in_trash' => 'Не найден Город в корзине', // если не было найдено в корзине
      'parent_item_colon'  => '', // для родителей (у древовидных типов)
